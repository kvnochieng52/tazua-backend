...
@section('title', 'Edit Blog: ' . $blog->title . ' - Admin - Tazua')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="admin-form-card">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('excerpt') is-invalid @enderror" id="excerpt" name="excerpt" rows="3"
                                            placeholder="A brief description of your blog post...">{{ old('excerpt', $blog->excerpt) }}</textarea>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="admin-form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($blog->published_at)
                                                <small class="form-text text-muted">Published:
                                                    {{ $blog->formatted_published_date }}</small>
                                            @else
                                                <small class="form-text text-muted">Not yet published</small>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="admin-form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="category" value="{{ old('category', $blog->category) }}" required
                                    ...
                                    <div class="admin-form-section">
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="thumbnail">{{ $blog->thumbnail ? 'Replace thumbnail' : 'Upload thumbnail' }}</label>
                                            <input type="file"
                                    ...
                                    <div class="admin-form-section">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                                name="meta_description" rows="3" placeholder="Leave empty to use excerpt">{{ old('meta_description', $blog->meta_description) }}</textarea>
                        ...
                        <!-- Hidden Delete Form -->
                        <form id="delete-form" action="{{ route('admin.blogs.destroy', $blog) }}" method="POST"
                            style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
